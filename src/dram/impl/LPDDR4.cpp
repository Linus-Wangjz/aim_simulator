...
class LPDDR4 : public IDRAM, public Implementation {
    RAMULATOR_REGISTER_IMPLEMENTATION(IDRAM, LPDDR4, "LPDDR4", "LPDDR4 Device Model")
        ...
        {"LPDDR4_3200", // name
            {
                ...
                29,     // nRPpb (18ns)
                68,     // nRAS (42ns)
                101,    // nRC (tRAS + tRPab (with all bank precharge) / tRAS + tRPpb (with per bank precharge))
                29,     // nWR
                12,     // nRTP
                11,     // nCWL
                6,      // nCCD
...
public:
    struct Node : public DRAMNodeBase<LPDDR4> {
        Clk_t m_final_synced_cycle = -1; // Extra CAS Sync command needed for RD/WR after this cycle

        Node(LPDDR4 *dram, Node *parent, int level, int id) : DRAMNodeBase<LPDDR4>(dram, parent, level, id) {};
    };
...
#define ACTION_DEF(OP)                                                                \
    ...
    m_actions[m_levels["rank"]]                                                       \
        ...
        m_actions[m_levels["bankgroup"]][m_commands["ACT4-2"]] = Lambdas::Action::BankGroup::ACT4b<LPDDR4>;
        m_actions[m_levels["bankgroup"]][m_commands["PRE4"]] = Lambdas::Action::BankGroup::PRE4b<LPDDR4>;
        ...
        m_actions[m_levels["bank"]][m_commands["ACT-2"]] = Lambdas::Action::Bank::ACT<LPDDR4>;
        m_actions[m_levels["bank"]][m_commands["PRE"]] = Lambdas::Action::Bank::PRE<LPDDR4>;
        // TODO: RDA and WRA actions may need to also update the sync time
        m_actions[m_levels["bank"]][m_commands["RDA"]] = Lambdas::Action::Bank::PRE<LPDDR4>;
        m_actions[m_levels["bank"]][m_commands["WRA"]] = Lambdas::Action::Bank::PRE<LPDDR4>;
    };
    ...
    void set_preqs() {
        ...
        // Rank Preqs
        m_preqs[m_levels["rank"]][m_commands["REFab"]] = Lambdas::Preq::Rank::RequireAllBanksClosed<LPDDR4>;
        m_preqs[m_levels["rank"]][m_commands["RFMab"]] = Lambdas::Preq::Rank::RequireAllBanksClosed<LPDDR4>;
...
#define PREQ_RANK_SYNC_DEF(OP, CASOP)                                     \
    ...
    //     m_rowhits[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowHit::Bank::RDWR<LPDDR4>;
    //     m_rowhits[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowHit::Bank::RDWR<LPDDR4>;
    // }
    ...
    //     m_rowopens[m_levels["bank"]][m_commands["RD"]] = Lambdas::RowOpen::Bank::RDWR<LPDDR4>;
    //     m_rowopens[m_levels["bank"]][m_commands["WR"]] = Lambdas::RowOpen::Bank::RDWR<LPDDR4>;
    // }
